...
namespace LivinParis_Graphique.MVVM.ViewModel
{
    public class CommandesViewModel : BaseViewModel
    {
        ...
        public CommandesViewModel(ClientViewModel clientViewModel)
        {
        ...
        private void LoadCommandes() {
            ...
            all = all.Where(x=> x.ClientUsername == ClientViewModel.ClientUsername).ToList();
        ...
        private void OpenCommandeDetails(object parameter) {
            if (parameter is Commande cmd) {
                var detailsVM = new ClientDetailCommandeViewModel(cmd, this);
                var detailsWindow = new ClientDetailCommande { DataContext = detailsVM };
                detailsWindow.ShowDialog();
                LoadCommandes();
            }
        }
